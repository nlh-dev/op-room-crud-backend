...
CREATE TABLE `users` (
    ...
    `op_users_state` BOOLEAN NOT NULL DEFAULT false,

    INDEX `users_op_users_role_fkey`(`op_users_role`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `patients` (
    ...
    INDEX `patients_patients_surgery_state_id_fkey`(`patients_surgery_state_id`),
    INDEX `patients_patients_surgery_type_id_fkey`(`patients_surgery_type_id`),
